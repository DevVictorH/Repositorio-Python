    ...
    def fazer_chamada(self, destinatario, duracao):
        ...
        if custo is not None:
            if self.plano.verificar_saldo() >= custo:
                ...
                return f"Chamada para {destinatario} realizada com sucesso. Saldo restante: ${self.plano.verificar_saldo(float())}"
            else:
...
# TODO: Crie um método custo_chamada para calcular o custo de uma chamada supondo o custo de $0.10 por minuto:
    def custo_chamada(self, duracao):
      custo_chamada = 0.10 * duracao
      return custo_chamada
